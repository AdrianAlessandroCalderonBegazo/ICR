...
// Docker (montada como volumen en docker-compose.yml). Sirve tanto la foto
// de proyectos como el fondo de portada — misma infraestructura, distinto
// campo de destino según el endpoint que la use.
const uploadsDir = path.join(__dirname, "..", "uploads");
fs.mkdirSync(uploadsDir, { recursive: true });

const MAX_SIDE = 1600; // px — suficiente para el fondo del hero a pantalla completa
const MAX_SIZE = 5 * 1024 * 1024; // 5MB de subida; el archivo guardado queda mucho más chico tras procesar
const SHARP_OUTPUT = {
...
// Reescala a un máximo de 1600px de lado (sin agrandar imágenes más chicas) y
